	...
	<section id="profile" class="section profile_section odd first blog_page">
		...
		<div class="section_header profile_section_header">
			<?php
				...
				// $user_photo = "https://graph.facebook.com/sebastian.gonzalez.r/picture?type=large";
			?>
		...
		<div id="content" class="site_content post_content" role="main">
            ...
            <?php while ( have_posts() ) : the_post(); ?>
                ...
                <?php if (!$post_protected) { ?>
					...
					<?php if ($post_type == 'post') {
						//===================================== Post tags list =====================================
						if ($post_categories_str) { ?><span class="post_categories"><span class="icon-align-left"></span><?php echo $post_categories_str; ?></span><?php }
